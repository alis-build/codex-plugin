...
The plugin's `discover` skill routes platform-shaped work to registry skills. Discovery is
local-first: probe with `alis skills suggest "<intended outcome>" --json` (instant, no
