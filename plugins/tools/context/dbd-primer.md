...
refreshes catalog metadata only — skills need no local files to be discoverable and load
live from the registry when used; `alis skills install <id>` stores a complete local copy.
